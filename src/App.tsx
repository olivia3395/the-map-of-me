  ...
  'boston': {
    ...
    onScreen: [
      { 
        ...
        genre: 'Drama',
        genreZh: '剧情',
        summary: 'A janitor at MIT has a gift for mathematics but needs help from a psychologist to find direction in his life.',
        summaryZh: '麻省理工学院的一名清洁工在数学方面极具天赋，但在心理学家的帮助下才找到了人生的方向。'
      },
      { 
        title: 'Cheers', 
        titleZh: '欢乐酒店', 
        location: 'Beacon Hill area', 
        locationZh: '灯塔山区域',
        genre: 'Sitcom',
        genreZh: '情景喜剧',
        summary: 'The regulars of the Boston bar "Cheers" share their experiences while working or drinking at the bar.',
        summaryZh: '波士顿“欢乐酒店”酒吧的常客们在酒吧工作或喝酒时分享着他们的经历。'
      },
      { 
        title: 'Fever Pitch', 
        titleZh: '极度狂热', 
        ...
        genre: 'Romance',
        genreZh: '浪漫',
        summary: 'A schoolteacher falls for a businesswoman, but his obsession with the Red Sox threatens their relationship.',
        summaryZh: '一名教师爱上了一位女商人，但他对红袜队的痴迷威胁到了他们的关系。'
      },
      { 
        title: 'Ted', 
        titleZh: '泰迪熊', 
        ...
        genre: 'Comedy',
        genreZh: '喜剧',
        summary: 'A man deals with his childhood teddy bear that has come to life and is now a foul-mouthed companion.',
        summaryZh: '一个男人不得不面对他童年时活过来的泰迪熊，它现在是一个满口脏话的伙伴。'
      },
    ],
    onThePage: [
      { 
        ...
        genreZh: '历史小说',
        summary: 'A young woman growing up in early 20th-century Boston navigates family, love, and independence.',
        summaryZh: '一个在20世纪初波士顿长大的年轻女子在家庭、爱情和独立之间寻找平衡。'
      },
      { 
        ...
        genre: 'Mystery',
        genreZh: '悬疑',
        summary: 'A struggling artist gets involved in a mystery surrounding the famous Gardner Museum heist.',
        summaryZh: '一名落魄的艺术家卷入了一场围绕著名的加德纳博物馆抢劫案的谜团。'
      },
      { 
        ...
        genre: 'Thriller',
        genreZh: '惊悚',
        summary: 'A group of literary greats in 19th-century Boston must solve a series of murders inspired by Dante\'s Inferno.',
        summaryZh: '19世纪波士顿的一群文学巨匠必须解决一系列受但丁《地狱篇》启发的谋杀案。'
      },
      { 
        ...
        genre: 'Detective',
        genreZh: '侦探',
        summary: 'Private investigator Spenser searches for a stolen medieval manuscript in the streets of Boston.',
        summaryZh: '私家侦探斯宾塞在波士顿街头寻找一份被盗的中世纪手稿。'
      },
    ],
    walkTheCity: [
